...
An NPL site is a contaminated area in the U.S. designated by the Environmental Protection Agency (EPA) for cleanup because it poses a risk to human health or the environment. National Priority List geospatial data were obtained from the [EPA's Envirofacts database](https://enviro.epa.gov/).
...
National Priority List sites are located throughout Georgia, but appear to be clustered together in a few regions. 
